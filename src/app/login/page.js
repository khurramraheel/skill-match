      ...
      <div className="row w-100 shadow rounded-3 overflow-hidden" style={{ backgroundColor: "#f8f9fa" }}>
        ...
        <div className="col-md-6 p-5 mx-5">  
          ...
          <div className="d-flex gap-2 mb-4 ">
            <button className="btn  fs-5 border-black rounded-pill py-2 w-50 d-flex align-items-center justify-content-center">
            <img src="https://img.icons8.com/color/16/000000/google-logo.png" alt="Google Logo"/> Sign in with Google
            </button>
            <button className="btn border-black w-50 d-flex py-2  align-items-center rounded-pill justify-content-center fs-5">
              <img src="https://img.icons8.com/ios-filled/16/000000/github.png" alt="GitHub Logo"  /> Sign up with Github
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              ...
              <input
                ...
                required  style={{backgroundColor:"rgb(239 239 239)", border: "1px solid grey"}}
              />
            ...
            <div className="form-check mb-3">
              <input
                type="checkbox"
                className={`form-check-input p-2 ${errors.agreed ? "is-invalid" : ""}`}
                name="agreed"
                checked={formData.agreed}
                onChange={handleChange} style={{backgroundColor:"rgb(239 239 239)", border: "1px solid grey"}}
              />
