    ...
    return (
        <div className='mt-5'>
            ...
            <div className='container py-4'>
                ...
                <ol className='fw-bold list-unstyled'>
                    <li className='mb-4'>
                        <h3 className='fw-bold fs-3'>1. Information We Collect</h3>
                        <p className='fs-5 fw-semibold py-2'>We collect the following types of information:</p>

                        <p className='fs-5 fw-bold'>1.1 Personal Information:</p>
                        ...
                        <p className='fs-5 fw-bold pt-3'>1.2 Usage Data:</p>
                        <ul className='fs-5 fw-medium'>
                        ...
                        <p className='fs-5 fw-bold pt-3'>1.3 Cookies and Tracking Technologies:</p>
                        <p className='fs-5 fw-semibold'>We use cookies, beacons, and similar tracking technologies to improve your experience, analyze trends, and gather demographic information.</p>
                    </li>

                    <li className='mb-4'>
                        <h3 className='fw-bold'>2. How We Use Your Information</h3>
                        <p className='fs-5 fw-semibold'>We use your personal data for the following purposes:</p>
                        <ul className='fs-5 fw-medium'>
                    ...
                    <li className='mb-4'>
                        ...
                        <p className='fs-5 fw-semibold'>We may share your information with:</p>
                        <ul className='fs-5 fw-medium'>
                    ...
                    <li className='mb-4'>
                        <h3 className='fw-bold'>5. Your Rights and Choices</h3>
                        <p className='fs-5 fw-semibold'>You have the right to:</p>
                        <ul className='fs-5 fw-medium'>
                        ...
                        <p className='fs-5 fw-semibold pt-2'>To exercise these rights, contact us at <a href="mailto:support@skillmatch.tech">support@skillmatch.tech</a>.</p>
                    </li>

                    <li className='mb-4'>
                        <h3 className='fw-bold'>6. Children's Privacy</h3>
                        <p className='fs-5 fw-semibold'>
                    ...
                    <li className='mb-4'>
                        <h3 className='fw-bold'>7. Changes to This Privacy Policy</h3>
                        <p className='fs-5 fw-semibold'>
