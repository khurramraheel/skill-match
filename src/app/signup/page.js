  ...
  return (
    <div className=" vw-100 vh-100 d-flex align-items-center justify-content-center" style={{ paddingTop:"5rem!important" }}>
      <div className="row w-100 shadow rounded-3 overflow-hidden" style={{ backgroundColor: "#f8f9fa" }}>
        {/* Left Side Image */}
        <div className="col-md-5 bg-primary d-none d-md-block p-0" style={{ backgroundImage: "url(/auth-cover.svg)", backgroundSize: "cover", backgroundPosition: "center"}}>
        ...
        <div className="col-md-6 p-5 mx-5">  
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              ...
              <input
                type="password"
                className={`form-control p2 ${errors.password ? "is-invalid" : ""}`}
                name="password"
